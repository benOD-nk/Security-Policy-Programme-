...
| **Business Owner** | Information Security / IT Management |
...
3.2 All user accounts must be uniquely identifiable. Shared accounts are prohibited
    except where technically unavoidable and formally approved.

3.3 Multi-factor authentication (MFA) is mandatory for all remote access and all
    access to systems classified as Critical or High.

3.4 Access rights must be reviewed at minimum every 6 months and immediately upon
    a change in role or employment status.
...
| Role | Responsibility |
|---|---|
| **Information Security** | Own and maintain this policy. Conduct periodic access reviews. |
| **IT Operations** | Implement and maintain access controls in accordance with this policy and applicable standards. |
| **HR** | Notify Information Security of joiners, movers, and leavers within **24 hours**. |
| **Line Manager** | Review and approve access requests for their direct reports based on business requirements. |
| **All Staff** | Comply with this policy and promptly report suspected access control violations. |

## 5. Related Documents

- **STD-001:** Access Control Standard
...
|---|---|---|---|---|
| 1.0 | August 24, 2025 | Benaiah Odamtten | Initial draft | Pending |
